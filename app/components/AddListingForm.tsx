...
export default function AddListingForm({
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (!res.ok) {
      alert(`${t('listing.error')}: ` + data.error);
      return;
    }
  ...
  <div className="flex flex-col">
   ...
   <div className="flex flex-col">
    ...
    <input
      ...
      required
      className={`px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.contact ? 'border-red-500' : 'border-gray-300'}`}
